...
class ShapCounterfactual(object):
    ...
    def explanation(self, instance):
        ...
        return {'explanation set':explanation_set, 'feature coefficient set':feature_coefficient_set, 'number active elements':number_active_elements, 'size explanation': minimum_size_explanation, 'relative size explanation':minimum_size_explanation_rel, 'time elapsed':time_elapsed, 'original score':score[0], 'new score':score_new[0], 'difference scores':difference_scores, 'explanation SHAP coefficients':expl_shap, 'output size shap': output_size_shap}      